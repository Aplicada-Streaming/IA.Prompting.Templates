...
```
Ejecuta /Tool-Prompts/Indexado-Documentado/Iniciar-Contexto en <tema>
```
...
| Carpeta | Dominio |
|---------|---------|
| [`Indexado-Documentado/`](Indexado-Documentado/) | Ciclo de indexar y documentar fuentes: ia-db, arranque de contexto y conjunto documental |
| [`Software/`](Software/) | Código fuente: QA y derivación de pruebas |
...
`Infra/` y `Seguridad/` se separan por objeto auditado, no por disciplina: `Infra/Revisar-Seguridad-Server.md` revisa la postura de un servidor o red desde adentro; `Seguridad/Auditoria-Seguridad.md` audita un portal web autenticado desde su URL pública.

---

## Prompts disponibles

### Indexado y documentación

| Tool-Prompt | Cuándo usarlo | Profile | Ejemplo de invocación |
|-------------|---------------|---------|-----------------------|
| [Iniciar-Contexto.md](Indexado-Documentado/Iniciar-Contexto.md) | Arrancar un chat cargando solo el contexto necesario de un tema | — (autónomo) | `Ejecuta /Tool-Prompts/Indexado-Documentado/Iniciar-Contexto en <tema>` |
| [Iniciar-Indexado.md](Indexado-Documentado/Iniciar-Indexado.md) | Crear (o regenerar) la `ia-db` de uno o más proyectos | Knowledge-Indexing | `Lee y ejecuta /Tool-Prompts/Indexado-Documentado/Iniciar-Indexado en <proyecto>` |
| [Actualizar-Indexado.md](Indexado-Documentado/Actualizar-Indexado.md) | Sincronizar una `ia-db` existente con los cambios de sus proyectos | Knowledge-Indexing | `Lee y ejecuta /Tool-Prompts/Indexado-Documentado/Actualizar-Indexado de <proyecto>` |
| [Crear-Documentacion-Fuente-Software.md](Indexado-Documentado/Crear-Documentacion-Fuente-Software.md) | Evaluar y documentar una solución, proyecto o workspace completo conforme al Marco de Documentación (ia-db + conjunto documental) | Solution-Documentation | `Lee y ejecuta /Tool-Prompts/Indexado-Documentado/Crear-Documentacion-Fuente-Software en la solución <origen> y deja en: <destino>` |
| [Actualizar-Documentacion.md](Indexado-Documentado/Actualizar-Documentacion.md) | Actualizar documentación existente de un proyecto | Repository-Documentation | `Lee y ejecuta /Tool-Prompts/Indexado-Documentado/Actualizar-Documentacion en <proyecto>` |
