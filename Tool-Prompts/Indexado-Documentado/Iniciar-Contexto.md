...
> **Invocación**: `Ejecuta /IA/IA.Prompts/Tool-Prompts/Indexado-Documentado/Iniciar-Contexto.md en {tema}`
>
...
- Si el proyecto no tiene ia-db, informarlo y proponer ejecutar `/IA/IA.Prompts/Tool-Prompts/Indexado-Documentado/Iniciar-Indexado.md` — no improvisar un barrido del repositorio.
